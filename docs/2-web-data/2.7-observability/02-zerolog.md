...
> 💻 完整可运行代码：[code-examples/02-web-data/observability/zerolog-gin/](https://github.com/skyhe58/guide-go/tree/main/code-examples/02-web-data/observability/zerolog-gin/)
> 🏷️ Demo 模式：纯 Go（直接运行）
